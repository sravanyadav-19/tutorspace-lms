...
const AnnouncementDetail = () => {
  ...
  const promptDelete = (commentId) => {
    setConfirmModal({ open: true, commentId })
  }
  ...
  return (
    <DashboardLayout userRole="student">
      <div className={styles.announcementDetail}>
        <button className={styles.backBtn} onClick={() => navigate('/student/announcements')}>← Back to Announcements</button>
                ...
                <div key={comment.id} className={styles.commentCard}>
                  <div className={styles.commentHeader}>
                    <div className={styles.commentAuthor}>
                      <div className={styles.commentAvatar}>{comment.author?.role?.name === 'teacher' ? '👨‍🏫' : '🎓'}</div>
                    ...
                    {comment.author?.id === user?.id && (
                      <button className={styles.deleteCommentBtn} onClick={() => promptDelete(comment.id)}>🗑️</button>
                    )}
                  </div>
