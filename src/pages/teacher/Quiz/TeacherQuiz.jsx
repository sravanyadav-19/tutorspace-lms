...
const TeacherQuiz = () => {
  ...
  const handleTogglePublish = async (quizId, isPublished) => {
    try {
      ...
      setQuizzes(prev => prev.map(q =>
        q.id === quizId ? { ...q, isPublished: !isPublished } : q
      ))
      setSuccess(isPublished ? 'Quiz unpublished' : 'Quiz published!')
      setTimeout(() => setSuccess(''), 3000)
    } catch (err) {
  ...
  const handleReleaseResults = async (quizId) => {
    ...
    try {
      ...
      setSuccess('Results released to students!')
      setTimeout(() => setSuccess(''), 3000)
    } catch (err) {
  ...
  return (
    <DashboardLayout userRole="teacher">
      <div className={styles.quizPage}>
        ...
        {loading ? (
          <div className={styles.loadingState}><p>Loading classes...</p></div>
        ) : classes.length === 0 ? (
              ...
              {showCreateForm && (
                <div className={styles.createForm}>
                  <h2 className={styles.formTitle}>
                    ✏️ New Quiz for {selectedClass?.name}
                  </h2>
                  ...
                  <div className={styles.formSection}>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <input
                        ...
                        placeholder="e.g. Chapter 5 Quiz, Midterm Test..."
                        value={quizTitle}
                        ...
                        <div key={qIndex} className={styles.questionCard}>
                          ...
                          <div className={styles.formGroup}>
                            ...
                            <textarea
                              ...
                              onChange={(e) => updateQuestion(
                                qIndex, 'questionText', e.target.value
                              )}
                              rows={2}
                            />
                          </div>
                                ...
                                >
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => updateOption(
                                      qIndex, optIndex, e.target.value
                                    )}
                                  />
                                </div>
                              ))}
                          ...
                          <div className={styles.formGroup}>
                            ...
                            <input
                              ...
                              onChange={(e) => updateQuestion(
                                qIndex, 'correctAnswer', e.target.value
                              )}
                            />
                          </div>
