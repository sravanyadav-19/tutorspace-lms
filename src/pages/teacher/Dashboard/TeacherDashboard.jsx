...
import { BookOpen, Users, Megaphone, ClipboardList, RefreshCw, FileText, BarChart3, Plus } from 'lucide-react'
      ...
      <div className={styles.teacherDashboard}>
        ...
        <div className={styles.quickActions}>
          ...
          <div className={styles.actionButtons}>
            ...
            <button className={styles.actionBtn} onClick={() => navigate('/teacher/analytics')}>
              <BarChart3 size={18} />
        ...
        {classes.length === 0 ? (
          ...
          <div className={styles.classesSection}>
            <div className={styles.sectionHeader}>
              <h2 className={styles.sectionTitle}>Your Assigned Classes</h2>
              ...
              {classes.slice(0, 3).map(cls => (
                <div key={cls.id} className={styles.classCard} onClick={() => navigate(`/teacher/classes/${cls.id}`)}>
                  <div className={styles.classCardHeader}>
                    <div className={styles.classIcon}><BookOpen size={24} color="#cc785c" /></div>
                  ...
                  <div className={styles.classInfo}>
                    ...
                    <div className={styles.classStats}>
                      <span><Users size={12} style={{ marginRight: '4px' }} />{cls._count?.enrollments || 0} enrolled students</span>
                      <span><Megaphone size={12} style={{ marginRight: '4px' }} /> {cls._count?.announcements || 0} updates posted</span>
                    </div>
                  </div>
                  ...
                  <div className={styles.classActions}>
                    ...
                    >
                      <Plus size={14} style={{ marginRight: '4px' }} /> Post Update
                    </Button>
                  </div>
                </div>
              ))}
