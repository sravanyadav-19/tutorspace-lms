    ...
    <DashboardLayout userRole="teacher">
      <div className={styles.newAnnouncementPage}>
        <div className={styles.pageHeader}>
          <button className={styles.backBtn} onClick={() => navigate('/teacher/classes')}>← Back to Classes</button>
          <h1 className={styles.pageTitle}>New Announcement</h1>
          <p className={styles.pageSubtitle}>Posting to Class ID: {classId}</p>
        </div>
        <form onSubmit={handleSubmit} className={styles.announcementForm}>
          <div className={styles.formCard}>
            ...
            <div className={styles.formActions}>
              ...
              <Button type="submit" variant="primary" size="lg" disabled={loading || !isValid}>{loading ? 'Posting...' : '📢 Post Announcement'}</Button>
            </div>
          </div>
        </form>
