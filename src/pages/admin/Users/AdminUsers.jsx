                  ...
                  {filteredUsers.length === 0 ? (
                    ...
                    filteredUsers.map(user => (
                      <tr key={user.id} className={styles.tr}>
                        ...
                        <td className={styles.td}><span className={user.emailVerified ? styles.verifiedYes : styles.verifiedNo}>{user.emailVerified ? <CheckCircle size={14} color="#5db872" /> : <XCircle size={14} color="#6c6a64" />}</span></td>
